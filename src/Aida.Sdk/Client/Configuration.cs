...
namespace Aida.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "1.0.366";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.0.366/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 1.0.366\n";
            report += "    SDK Package Version: 1.0.366\n";
